    ...
    <div class="row">
      <div class="col-sm-6 text-black mt-5" >
        ...
        <div class="px-5 ms-xl-4">
          ...
          <span class="h1 fw-bold mb-0">Garfield's Restaurant</span>
        </div>
      ...
      <div class="col-sm-2 px-0 d-none d-sm-block mt-5">
        <img style="border-radius: 30px; position:relative; right:40px; width:700px;"  src="https://cdn.pixabay.com/photo/2017/08/03/21/48/drinks-2578446__340.jpg" alt="Login image" style="object-fit: cover; object-position: left;">
      </div>
    </div>
  </div>
 </section>
